...
################################################################
# This is a generated script based on design: multiplex_design
#
...
# source multiplex_design_script.tcl
...
set design_name multiplex_design
...
\
  ...
  # Create instance: multiplex_wrapper_0, and set properties
  set block_name multiplex_wrapper
  set block_cell_name multiplex_wrapper_0
  if { [catch {set multiplex_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $multiplex_wrapper_0 eq "" } {
  ...
  connect_bd_net -net multiplex_wrapper_0_y  [get_bd_pins multiplex_wrapper_0/y] \
  [get_bd_ports led]
  connect_bd_net -net sw_1  [get_bd_ports sw] \
  [get_bd_pins multiplex_wrapper_0/a]
