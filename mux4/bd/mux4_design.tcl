...
################################################################
# This is a generated script based on design: mux4_design
#
...
\
  ...
  # Create instance: mux4_wrapper_0, and set properties
  set block_name mux4_wrapper
  set block_cell_name mux4_wrapper_0
  if { [catch {set mux4_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mux4_wrapper_0 eq "" } {
  ...
  [get_bd_pins mux4_wrapper_0/a]
  connect_bd_net -net mux4_wrapper_0_y  [get_bd_pins mux4_wrapper_0/y] \
  [get_bd_ports led]
