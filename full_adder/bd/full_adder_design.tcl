...
################################################################
# This is a generated script based on design: full_adder_design
#
...
# source full_adder_design_script.tcl
...
set design_name full_adder_design
...
\
  ...
  # Create instance: full_adder_wrapper_0, and set properties
  set block_name full_adder_wrapper
  set block_cell_name full_adder_wrapper_0
  if { [catch {set full_adder_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $full_adder_wrapper_0 eq "" } {
  ...
  connect_bd_net -net full_adder_wrapper_0_s  [get_bd_pins full_adder_wrapper_0/s] \
