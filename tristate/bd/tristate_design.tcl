...
################################################################
# This is a generated script based on design: tristate_design
#
...
# source tristate_design_script.tcl
...
set design_name tristate_design
...
\
  ...
  # Create instance: tristate_wrapper_0, and set properties
  set block_name tristate_wrapper
  set block_cell_name tristate_wrapper_0
  if { [catch {set tristate_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tristate_wrapper_0 eq "" } {
  ...
  [get_bd_pins tristate_wrapper_0/a]
  connect_bd_net -net sw0_1  [get_bd_ports sw0] \
  [get_bd_pins tristate_wrapper_0/en]
  connect_bd_net -net tristate_wrapper_0_out  [get_bd_pins tristate_wrapper_0/y] \
  [get_bd_ports led]
